...
plot_loss(history, ax, '-' , cmap(1), 'Boundary_Cond_U',     "losses", ["BCD_u_x0", "BCD_u_x1", "BCD_u_y0", "BCD_u_y1"],)
plot_loss(history, ax, '-' , cmap(2), 'Boundary_Cond_V',     "losses", ["BCD_v_x0", "BCD_v_x1", "BCD_v_y0", "BCD_v_y1"])
